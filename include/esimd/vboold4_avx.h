...
namespace esimd
{
  ...
  __forceinline vboold4 operator !(const vboold4& a) { return _mm256_xor_pd(a, vboold4(esimd::True)); }
  ...
  __forceinline vboold4 operator !=(const vboold4& a, const vboold4& b) { return _mm256_xor_pd(a, b); }
  __forceinline vboold4 operator ==(const vboold4& a, const vboold4& b) { return _mm256_xor_pd(_mm256_xor_pd(a,b),vboold4(esimd::True)); }
