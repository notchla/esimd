...
#include "detail/simd_wrapper_types.h"
...
#elif defined(__AVX2__)  && !defined(ESIMD_ARM64)
...
#if defined(__SSE4_1__) || defined(ESIMD_ARM64)
...
#if defined(__AVX2__) || defined(__ARM_NEON) || defined(ESIMD_ARM64)
...
#if !defined(_M_ARM64)
          return vreinterpretq_f32_u8(vqtbl1q_u8( (uint8x16_t)v.v.data, _MN_SHUFFLE(i0, i1, i2, i3)));
#else
          // Avoids C4576 (no mixing C+CPP syntax), and C4002 (comma inside macro invocation)
          uint8x16_t _shuffle = _MN_SHUFFLE(i0, i1, i2, i3);
          return vreinterpretq_f32_u8(vqtbl1q_u8( (uint8x16_t)v.v.data, _shuffle));
#endif
      }
      template<int i0, int i1, int i2, int i3>
      __forceinline vfloat4 shuffle(const vfloat4& a, const vfloat4& b) {
#if !defined(_M_ARM64)
          return vreinterpretq_f32_u8(vqtbl2q_u8( (uint8x16x2_t){(uint8x16_t)a.v.data, (uint8x16_t)b.v.data}, _MF_SHUFFLE(i0, i1, i2, i3)));
#else
          // Avoids C4576 (no mixing C+CPP syntax), and C4002 (comma inside macro invocation)
          uint8x16_t _shuffle = _MF_SHUFFLE(i0, i1, i2, i3);
          uint8x16x2_t _ab = {(uint8x16_t)a.v.data, (uint8x16_t)b.v.data};
...
#if defined(__SSE3__) && !defined(ESIMD_ARM64)
