...
namespace esimd
{
  ...
  __forceinline vboolf4 operator !(const vboolf4& a) { return _mm_xor_ps(a, vboolf4(esimd::True)); }
...
#if !defined(_M_ARM64)
    return vreinterpretq_f32_u8(vqtbl1q_u8( vreinterpretq_u8_s32((int32x4_t)v.v.data), _MN_SHUFFLE(i0, i1, i2, i3)));
#else
